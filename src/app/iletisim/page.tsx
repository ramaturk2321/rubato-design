...
export const metadata: Metadata = {
  title: "İletişim",
  description: "Rubato Design ile iletişime geçin. 0216 379 07 08 | WhatsApp: 535 664 77 52 | info@eymenajans.com.tr",
};
  ...
  return (
    <div className="min-h-screen px-6 py-16 md:px-16 lg:px-24">
      <div className="max-w-3xl">
        ...
        <p className="text-xl font-black mb-8">BİZİ ARAYIN!</p>

        <div className="flex flex-col gap-4">
          <a
            href="tel:02163790708"
            className="text-2xl font-bold underline hover:text-brand-dark/70 transition-colors"
          >
            0216 379 07 08
          </a>
          ...
          <a
            href="mailto:info@eymenajans.com.tr"
            className="text-2xl font-bold underline hover:text-brand-dark/70 transition-colors"
          >
            info@eymenajans.com.tr
          </a>
        </div>
      </div>
